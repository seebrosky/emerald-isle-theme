						...
						<div class="p-8">
							...
							<h2 class="mb-4 text-2xl font-bold leading-tight text-site-text lg:text-3xl">
								<span class="bg-gradient-to-r from-current to-current bg-[length:0%_2px] bg-left-bottom bg-no-repeat transition-all duration-300 group-hover:bg-[length:100%_2px]">
									<?php esc_html_e( 'How to Build a High-Performing WordPress Website in 2026', 'emerald-isle' ); ?>
								</span>
							</h2>

							<p class="mb-5 text-xs font-bold uppercase tracking-wide text-site-text-muted">
								<?php esc_html_e( 'June 4, 2026', 'emerald-isle' ); ?> <span class="mx-2">•</span> <?php esc_html_e( '6 min read', 'emerald-isle' ); ?>
							</p>

							<p class="mb-6 leading-7 text-site-text-muted">
								<?php esc_html_e( 'A complete step-by-step guide to planning, building, and launching a fast, secure, and SEO-friendly WordPress website.', 'emerald-isle' ); ?>
							</p>
						</div>
					</div>
				</article>
