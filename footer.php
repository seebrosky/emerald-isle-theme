            ...
            <div>
                ...
                <div class="flex gap-1 text-sm text-white/70">
                    <a href="#" class="flex items-center justify-center size-12 lg:size-8 text-white hover:text-brand-primary transition">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8.5 w-8.5 lg:h-4.5 lg:w-4.5 fill-current">
                            <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584l-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
                        </svg>
                    </a>
                    <a href="#" class="flex items-center justify-center size-12 lg:size-8 text-white hover:text-brand-primary transition">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="h-9 w-9 lg:h-5 lg:w-5 fill-current">
                    ...
                    <a href="#" class="flex items-center justify-center size-12 lg:size-8 text-white hover:text-brand-primary transition">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-9 w-9 lg:h-5 lg:w-5 fill-current">
                    ...
                    <a href="#" class="flex items-center justify-center size-12 lg:size-8 text-white hover:text-brand-primary transition">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 432 416" class="h-8.5 w-8.5 lg:h-4.5 lg:w-4.5 fill-current">
