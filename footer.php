        ...
        <div class="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
            ...
            <div>
                ...
                <div class="flex gap-1 text-sm text-white/70">
                    ...
                    <!-- Github --> 
                    <a href="#" class="flex items-center justify-center size-12 lg:size-8 text-white hover:text-brand-primary transition relative -top-[1px]">
                ...
                <a href="#top" class="btn btn-outline mt-8">
